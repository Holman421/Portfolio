...
const avatarSlice = createSlice({
   ...
   initialState,
   reducers: {
      setAreAboutMeTransitionsOn: (state, action: ToggleBoolean) => {
         state.areAvatarTransitionsOn = action.payload;
      },
      setSelectedMode: (state, action: SetSelectedMode) => {
         state.selectedMode = action.payload;
      },
      setApplyFirstAppearTransition: (state, action: ToggleBoolean) => {
         state.applyFirstAppearTransition = action.payload;
      },
      setShowAboutMeContainers: (state, action: ToggleBoolean) => {
         state.showAboutMeContainers = action.payload;
      },
      setShowSkillsContainers: (state, action: ToggleBoolean) => {
